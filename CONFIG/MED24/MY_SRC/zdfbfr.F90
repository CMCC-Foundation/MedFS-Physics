...
!# if defined key_mfs
!             ! Artificially increase the bottom friction in the
!             ! portion of the Atlantic box close to Gibraltar
!             ! P.Oddo
!         IF(lwp) WRITE(numout,*) '      Artificially increase the bottom friction in the &
!                                       & portion of the Atlantic box close to Gibraltar '
!!CDIR NOVERRCHK
!         DO jj = mj0(76), mj1(166)
!!CDIR NOVERRCHK
!            DO ji = mi0(224), mi1(299)
!               bfrua(ji,jj) = bfrua(ji,jj) * 5.0
!               bfrva(ji,jj) = bfrva(ji,jj) * 5.0
!            END DO
!         END DO
!# endif
