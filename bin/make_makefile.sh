  ...
  do
    case $prog in
     ...
     ww3_shel) IDstring='Generic shell'
               core='w3fldsmd w3initmd w3wavemd w3wdasmd w3updtmd nemowwcoupling'
               data='w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd'
               prop="$pr"
  ...
  do
    ...
    for mod in W3GDATMD W3WDATMD W3ADATMD W3ODATMD W3IDATMD \
              CONSTANTS W3SERVMD W3TIMEMD W3ARRYMD W3DISPMD \
               ...
               WMUNITMD WMINIOMD WMIOPOMD NemoWwCoupling OutNetCDF
    do
      case $mod in
         'NemoWwCoupling'  ) modtest=nemowwcoupling.o ;;
         'OutNetCDF'    ) modtest=outnetcdf.o ;;
