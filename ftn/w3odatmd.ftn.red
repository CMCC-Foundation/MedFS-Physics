...
!/     
      ...
      INTEGER, PARAMETER      :: NOGRD = 33
      INTEGER, PARAMETER      :: NOSWLL=  2
!! ini emanuela
!      INTEGER, PARAMETER      :: NOEXTR=  3
      INTEGER, PARAMETER      :: NOEXTR=  4
!! end emanuela
...
!
      DATA IDOUT  / 'Water depth         ' , 'Current vel.        ' , &
                    ...
                    'Radiation stresses  ' , 'DRAG COEFFICIENT    ' , &
                    'Zonal Stokes Drift  ' , 'Merid Stokes Drift  ' , &
                    'User defined #2     ' /
!/
!/ Data structures
!/
...
!/MPI      IF ( NRQTR .EQ. 0 ) IRQTR  => OUTPTS(IMOD)%OUT3%IRQTR
